...
data=pd.read_csv("diopter_data_combined.csv")
print(data)
csv_file = "diopter_data_combined.csv"
model = DiopterDataModel(csv_file)

print(model.get_diopter(322))  
print(model.get_diopter(642))  
print(model.get_diopter(464))  
print(model.get_diopter(1000))
